                ...
                children: [
                  Expanded(
                    child: Column(
                      children: [
                        _buildServiceBox(
                            context, homeSubCategories[0], true, false),
                        SizedBox(height: 25),
                        _buildServiceBox(
                            context, homeSubCategories[2], false, true),
                      ],
                    ),
                  ),
                  SizedBox(width: 15),
                  Expanded(
                    child: Column(
                      children: [
                        _buildServiceBox(
                            context, homeSubCategories[3], false, true),
                        SizedBox(height: 25),
                        _buildServiceBox(
                            context, homeSubCategories[1], true, false),
                      ],
                    ),
                  ),
                ],
